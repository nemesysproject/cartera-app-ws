...
const options: swaggerJsdoc.Options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description:
                'Mock REST API que replica los endpoints de múltiples servicios: ' +
        ...
        paths: {
            '/wsfacturacioncarteras/api/v1/generar': {
                post: {
                    ...
                    description:
                        'Genera los datos de clientes para facturación a partir de una fecha de generación. ' +
            ...
            '/wsfacturacioncarteras/api/v1/enviar': {
                post: {
                    ...
                    description:
                        'Ejecuta el proceso de facturación enviando los clientes generados en una fecha, ' +
            ...
            '/wsfacturacioncarteras/api/v1/enviar-correos': {
                post: {
                    ...
                    description:
                        'Inicia el proceso de envío de correos electrónicos a los clientes facturados. ' +
            ...
            '/api/comprobantes/creaComprobante': {
                post: {
                    ...
                    description:
                        'Crea un comprobante electrónico — puede ser una **Factura de Interés** (`FERequest`) ' +
            ...
            '/api/comprobantes/ackComprobante': {
                put: {
                    ...
                    description:
                        'Confirma el último comprobante procesado como recibido (modo offline). ' +
            ...
            '/api/replicaciones/general': {
                post: {
                    ...
                    description:
                        'Inicia el proceso de replicación general. Proyectos conocidos: ' +
            ...
            '/api/replicaciones/especifica': {
                post: {
                    ...
                    description:
                        'Inicia el proceso de replicación específica. Proyectos conocidos: ' +
